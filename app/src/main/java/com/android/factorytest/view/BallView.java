...
//            mBalls[i].mass = (int) (Math.PI * mBalls[i].radius * mBalls[i].radius);
    ...
    public static String timeParse(long timestamp) {
        ...
        return String.format("%02d:%02d:%02d %03d",hour,minute,seconds,millisecond) ;
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText(timeParse(System.currentTimeMillis()-timezero), 128, 128, drawPaint);
